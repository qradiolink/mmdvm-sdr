 ...
 *   Copyright (C) 2022,2023 by Adrian Musceac YO8RZZ
 *
...
/** Replaced with Terminator with LC
...
const uint8_t IDLE_DATA[] =
        {0x00, 0xCC, 0x01, 0x80, 0x01, 0x94, 0x01, 0x48, 0x08, 0xB0, 0x08, 0x80, 0x04,
         0xAD, 0xFF, 0x57, 0xD7, 0x5D, 0xF5, 0xD9, 0x65, 0x90, 0x01, 0x78, 0x00, 0xD0,
         0x08, 0x40, 0x14, 0x00, 0x0D, 0x80, 0x15 };
...
const uint32_t STARTUP_COUNT = 10U;
